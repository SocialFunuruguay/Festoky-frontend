...
import '@/components/desktop/header/Header.css';
...
import iconoUsuario from '/iconos/icono-usuario.png';
...
const handleProveedorClick = () => {
  if (!usuario) {
    navigate("/login");
  } else if (usuario.es_proveedor) {
    navigate("/panel-proveedor"); // Cambiá por la ruta real del panel de proveedor si es otra
  } else {
    navigate("/ser-proveedor"); // Ruta para convertirse en proveedor
  }
};
    ...
    <div className="menu__item">
      ...
      <div className="header__right">
        <div className="proveedor-link">
           <button className="btn-proveedor" onClick={handleProveedorClick}>Sé Proveedor</button>
        </div>
